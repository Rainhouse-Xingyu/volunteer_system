...
public interface RegistrationMapper extends BaseMapper<Registration> {
    ...
    @Select("<script>" +
            "SELECT r.*, a.title as activityTitle, a.location, a.start_time, a.end_time, a.quota, a.current_participants as currentParticipants, a.reward_points as rewardPoints, " +
